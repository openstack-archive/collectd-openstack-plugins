...
from collectd_gnocchi.meters.base import Meter
...
collectd_class = 'collectd_gnocchi.tests.test_meters_base.CollectdMock'
...
class MetersTest(TestCase):
    ...
    #@mock.patch('collectd_gnocchi.meters.base.LOGGER')
