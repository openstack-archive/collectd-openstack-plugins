...
from collectd_gnocchi.tests.base import TestCase
from collectd_gnocchi.tests.base import Value
...
class PluginTest(TestCase):
    ...
    def setUp(self):
        ...
        client_class \
            = self.get_mock('collectd_gnocchi.keystone_light').ClientV2
        client_class.return_value\
            .get_service_endpoint.return_value = "https://test-gnocchi.tld"

        # TODO(emma-l-foley): Import at top and mock here
        from collectd_gnocchi.plugin import instance
        from collectd_gnocchi.plugin import Plugin
    ...
    def test_write(self):
        ...
        from collectd_gnocchi.sender import HTTP_CREATED
        ...
        expected_args = ('https://test-gnocchi.tld/v1/resource/generic/' +
                         'localhost-0/metric/cpu.freq/measures',)
        expected_kwargs = {
            'data': [{
                "source": "collectd",
    ...
    def test_write_auth_failed2(self):
        ...
        # tell the auth client to rise an exception
        keystone \
            = self.get_mock('collectd_gnocchi.keystone_light')
    ...
    def test_reauthentication(self):
        ...
        from collectd_gnocchi.sender import HTTP_UNAUTHORIZED
