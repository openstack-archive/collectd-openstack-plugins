...
date
mysql --user==root --password=secretmysql gnocchi -e "show tables" || true
mysql --user==root --password=secretmysql gnocchi -e "select name from metric" || true
mysql --user==root --password=secretmysql ceilometer -e "show tables" || true
mysql --user==root --password=secretmysql ceilometer -e "select name from meter" || true
