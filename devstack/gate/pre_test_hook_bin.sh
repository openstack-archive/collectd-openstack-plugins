#!/bin/bash
    ...
    # TODO: Move cloning to top of file
    ...
    git checkout -b stable/3.1 --track origin/stable/3.1
    cd $TMP_DIR
    # TODO(emma-l-foley): GIT_BRANCH["gnocchi"]=stable/3.1 might work instead of all this
