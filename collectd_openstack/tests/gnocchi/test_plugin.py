...
class TestPlugin(unittest.TestCase):
    ...
    @mock_collectd()
    @mock_config(BATCH_SIZE=2, OS_USERNAME='admin', OS_PASSWORD='admin',
                 OS_AUTH_URL='internal')
    @mock_value()
    def test_write(self, data, config, collectd, client, post, get_metric_id):
        ...
        post.assert_called_once_with(
            ...
            data=match.json('[{"timestamp": "1973-11-29T21:33:09", '
                            '"value": 1234}, {"timestamp": '
                            '"1973-11-29T21:33:09", "value": 1234}]'),
    ...
    @mock.patch.object(common_sender, 'ClientV3', autospec=True)
    @mock_collectd()
    @mock_config(OS_USERNAME='admin', OS_PASSWORD='admin',
                 OS_AUTH_URL='internal')
    @mock_value()
