...
COLLECTD_AODH_SEVERITYS
~~~~~~~~~~~~~~~~~~~~~~~
    (meter=severity) a comma seperated list of pairs, defining meters and the
    severity of the alarms they will trigger if there value goes above a
    ...
    Example: COLLECTD_AODH_SEVERITYS='"<meter>" <severity>, "<meter>" <severity>'
