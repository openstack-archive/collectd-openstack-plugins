...
COLLECTD_CEILOMETER_VERBOSE
    (False|True) Sets this to True to make collectd-ceilometer debugging
    messages visible as info messagges. This could be useful when running the
    plugin inside a collectd compiled without debug messages support.
    Default: 0
