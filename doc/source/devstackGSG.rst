...
created/updated for all notifications sent from collectd. If the notification
is based on breaking a threshold then a threshold alarm is created, any other
