...
# this prevent openstack from using another version of the plugin that the one
# contined on the folder of the Vagrantfile
...
pushd "$DEVSTACK_DIR"
    ...
    # where the Vagrantfile is (tipically /vagrant)
