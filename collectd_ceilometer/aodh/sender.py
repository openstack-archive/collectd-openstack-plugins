...
class Sender(object):
    ...
    def send(self, metername, severity, resource_id, message):
        ...
        if update_alarm is True:
            ...
            # TODO(helena-mcgough): make threshold match Notification threshold
            # update appropriate alarm type
        ...
        if result.status_code == HTTP_UNAUTHORIZED:
            ...
            if auth_token is not None:
                if update_alarm is True:
                    ...
                    # create the payload for the update requests
                    # TODO(helena-mcgough): make threshold match
    ...
    def _get_alarm_id(self, alarm_name, severity, metername, alarm_type):
