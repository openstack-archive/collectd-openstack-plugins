...
class TestAttribute(unittest.TestCase):
    ...
    def test_all_attributes(self):
        self.assertEqual(
            {Configuration.BATCH_SIZE, Configuration.CEILOMETER_URL_TYPE,
             Configuration.CEILOMETER_TIMEOUT, Configuration.OS_AUTH_URL,
             Configuration.OS_USERNAME, Configuration.OS_PASSWORD,
             Configuration.OS_TENANT_NAME, Configuration.VERBOSE,
             Configuration.UNITS},
            Configuration.all_attributes())
