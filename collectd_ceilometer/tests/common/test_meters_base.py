...
class MetersTest(TestCase):
    ...
    @mock.patch.object(Meter, 'alarm_severity', spec=callable)
    def test_incorrect_alarm_severity(self, a_severity):
        """Test the incorrect severity setting.
        ...
        Expected behaviour: Result will be True.
        """
        a_severity.return_value = None

        metername = self.meter.meter_name(self.vl)
        result = a_severity(self.vl, metername)
