...
class TestConfig(TestCase):
    ...
    def test_user_severities(self, LOGGER):
        ...
        Expected-behaviour: Comparisons should all return true
        """
        node = config_module(
            values=self.default_values,
            severities={'age': 'low',
    ...
    def test_user_severities_invalid(self, LOGGER):
        ...
        Set-up: Configure the node with on defined severity
        ...
        Expected-behaviour: Method will return None
    ...
    def test_user_severities_invalid_node(self, LOGGER):
        ...
        Test: Read the incorrect configuration node
              Compare the expected results for the method
        Expected-behaviour: Error will be recoreded in the log
    ...
    def test_read_alarm_severities(self, LOGGER):
        ...
        Set-up: Set up an node configured with a severities dictionary defined
