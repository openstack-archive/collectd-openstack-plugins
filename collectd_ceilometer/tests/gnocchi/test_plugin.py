...
class TestPlugin(unittest.TestCase):
    ...
    @mock_value()
    def test_write(self, data, config, collectd, ClientV2, post):
        ...
        post.assert_called_once_with(
            'https://test-gnocchi.tld/v1/resource/generic/' +
    ...
    def test_write_auth_failed(
            self, data, config, collectd, LOGGER, ClientV2, post):
    ...
    def test_request_error(
            self, data, config, collectd, ClientV2, post):
    ...
    @mock_config()
    @mock_value()
    def test_reauthentication(self, data, config, collectd, ClientV2, post):
    ...
    @mock_config()
    @mock_value()
    def test_exceptions(self, data, config, collectd, LOGGER, Writer, ClientV2, post):
