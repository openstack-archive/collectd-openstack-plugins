...
class TestPlugin(unittest.TestCase):
    ...
    def test_notify(self, data, config, collectd, ClientV3, put,
        ...
        _get_alarm_id.return_value = False, None
        ...
        put.assert_called_once_with(
            'https://test-aodh.tld' +
            '/v2/alarms/my-alarm-id',
            data=match.json({"state": "insufficient data",
                             "name": "cpu.freq(localhost-0)",
                             "severity": None,
                             "type": "threshold",
                             "threshold_rule": {"meter_name": "cpu.freq",
                                                "threshold": 1, },
                             }),
        ...
        # Test when an event alarm will be updated
        _get_alarm_id.return_value = True, 'my-alarm-id'
        _get_alarm_type.return_value = 'event'
        ...
        put.assert_called_once_with(
            ...
            data=match.json({"state": "insufficient data",
                             ...
                             "severity": None,
                             "type": "event",
                             "event_rule": {"event_type": "cpu.freq", },
                             }),
            headers={'Content-type': 'application/json',
                     'X-Auth-Token': auth_client.auth_token},
            timeout=1.0)
