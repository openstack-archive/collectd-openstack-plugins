...
class TestAttribute(unittest.TestCase):
    ...
    def test_all_attributes(self):
        self.assertEqual(
            {HasSomeAttributes.boolean, HasSomeAttributes.integer,
             HasSomeAttributes.string, HasSomeAttributes.required,
             HasSomeAttributes.default, HasSomeAttributes.dictionary},
