...
class TestAttribute(unittest.TestCase):
    ...
    def test_all_attributes(self):
        self.assertEqual(
            dict(boolean=HasSomeAttributes.boolean,
                 integer=HasSomeAttributes.integer,
                 string=HasSomeAttributes.string,
                 required=HasSomeAttributes.required,
                 default=HasSomeAttributes.default,
                 dictionary=HasSomeAttributes.dictionary),
            dict(HasSomeAttributes.all_attributes()))
    ...
    def test_check_required_attributes_when_required(self):
        ...
        try:
            ...
            self.assertEqual(
                "required attributes not found ('required')", str(ex))
        else:
