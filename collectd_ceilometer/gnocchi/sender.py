...
from collectd_ceilometer.common.basesender import BaseSender
...
class Sender(BaseSender):
    ...
    def _handle_http_error(self, exc, metername,
        ...
        if response.status_code == BaseSender.HTTP_NOT_FOUND:
            ...
            if result.status_code == BaseSender.HTTP_CREATED:
                LOGGER.debug('Result: %s', BaseSender.HTTP_CREATED)
            else:
